...
<body>
    ...
    <main>
        ...
        <nav class="user-info__menu">
            ...
            <ul>
                <li>
                    <a id="option-1">Perfil</a>
                </li>


                <li>
                    <a id="option-2">Pedidos</a>
                </li>

                <li>
                    <a id="option-3">Lista de deseos</a>
                </li>
            </ul>
        </nav>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const menuLinks = document.querySelectorAll('.user-info__menu a');

    // Obtener todos los contenedores de opciones
    const optionContainers = document.querySelectorAll('.info-user__container > div');

    // Función para mostrar la opción seleccionada y ocultar las demás
    function showOption(optionId) {
        optionContainers.forEach(container => {
            if (container.classList.contains(optionId)) {
